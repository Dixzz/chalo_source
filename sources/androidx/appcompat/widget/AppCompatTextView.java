...
public class AppCompatTextView extends TextView implements w9, r9 {
    private final AppCompatBackgroundHelper mBackgroundTintHelper;
    private boolean mIsSetTypefaceProcessing;
    private Future<p7> mPrecomputedTextFuture;
    ...
    private void consumeTextFutureAndSetBlocking() {
        Future<p7> future = this.mPrecomputedTextFuture;
        if (future != null) {
            try {
                this.mPrecomputedTextFuture = null;
                h.v0(this, future.get());
    ...
    public void setTextMetricsParamsCompat(p7.a aVar) {
        ...
        setTextDirection(i2);
        if (i < 23) {
            float textScaleX = aVar.f2774a.getTextScaleX();
            getPaint().set(aVar.f2774a);
    ...
    public void setCompoundDrawablesRelativeWithIntrinsicBounds(int i, int i2, int i3, int i4) {
        ...
        Drawable b = i != 0 ? u0.b(context, i) : null;
        Drawable b2 = i2 != 0 ? u0.b(context, i2) : null;
        Drawable b3 = i3 != 0 ? u0.b(context, i3) : null;
        if (i4 != 0) {
            drawable = u0.b(context, i4);
        }
