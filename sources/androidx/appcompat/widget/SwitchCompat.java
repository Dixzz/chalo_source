...
public class SwitchCompat extends CompoundButton {
    ...
    private void setOffStateDescriptionOnRAndAbove() {
        if (Build.VERSION.SDK_INT >= 30) {
            ...
            new u8(androidx.core.R.id.tag_state_description, CharSequence.class, 64, 30).e(this, obj);
        }
    }
    ...
    private void stopDrag(MotionEvent motionEvent) {
        ...
        if (z2) {
            this.mVelocityTracker.computeCurrentVelocity(Indexable.MAX_INDEXABLES_TO_BE_UPDATED_IN_ONE_CALL);
    ...
    public void setSwitchTextAppearance(Context context, int i) {
        ...
        if (obtainStyledAttributes.getBoolean(R.styleable.TextAppearance_textAllCaps, false)) {
            this.mSwitchTransformationMethod = new a1(getContext());
        } else {
    ...
    public void setThumbResource(int i) {
        setThumbDrawable(u0.b(getContext(), i));
    }
    ...
    public void setTrackResource(int i) {
        setTrackDrawable(u0.b(getContext(), i));
    }
    ...
    public SwitchCompat(Context context, AttributeSet attributeSet, int i) {
        ...
        r8.u(this, context, iArr, attributeSet, obtainStyledAttributes.getWrappedTypeArray(), i, 0);
