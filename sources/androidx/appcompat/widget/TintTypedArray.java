...
public class TintTypedArray {
    ...
    public ColorStateList getColorStateList(int i) {
        int resourceId;
        ColorStateList a2;
        if (!this.mWrapped.hasValue(i) || (resourceId = this.mWrapped.getResourceId(i, 0)) == 0 || (a2 = u0.a(this.mContext, resourceId)) == null) {
    ...
    public Drawable getDrawable(int i) {
        ...
        return u0.b(this.mContext, resourceId);
    }
    ...
    public Typeface getFont(int i, int i2, y5.c cVar) {
        ...
        return y5.b(context, resourceId, typedValue, i2, cVar, null, true, false);
    }
