...
public class DropDownListView extends ListView {
    ...
    public static class GateKeeperDrawable extends x0 {
    ...
    public int measureHeightOfChildrenCompat(int i, int i2, int i3, int i4, int i5) {
        ...
        while (i8 < count) {
            ...
            if (i11 > 0) {
                i6 = View.MeasureSpec.makeMeasureSpec(i11, CommonUtils.BYTES_IN_A_GIGABYTE);
            } else {
