...
public class AppCompatTextViewAutoSizeHelper {
    ...
    public static <T> T invokeAndReturnWithDefault(java.lang.Object r1, java.lang.String r2, T r3) {
        /*
    ...
    public void loadFromAttributes(AttributeSet attributeSet, int i) {
        ...
        r8.u(textView, textView.getContext(), iArr, attributeSet, obtainStyledAttributes, i, 0);
        ...
        if (supportsAutoSizeText()) {
            ...
            if (length > 0) {
                ...
                if (!setupAutoSizeUniformPresetSizesConfiguration()) {
                    StringBuilder i0 = hj1.i0("None of the preset sizes is valid: ");
    ...
    public void setAutoSizeTextTypeWithDefaults(int i) {
        ...
        if (i == 0) {
            ...
            throw new IllegalArgumentException(hj1.I("Unknown auto-size text type: ", i));
        }
    }
