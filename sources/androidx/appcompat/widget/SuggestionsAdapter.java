...
public class SuggestionsAdapter extends z9 implements View.OnClickListener {
    ...
    private Drawable getDrawableFromResourceValue(String str) {
        ...
        try {
            ...
            String str2 = "android.resource://" + this.mProviderContext.getPackageName() + ConnectionFactory.DEFAULT_VHOST + parseInt;
            ...
            Drawable b = q5.c.b(context, parseInt);
            storeInIconCache(str2, b);
            return b;
    ...
    @Override // defpackage.x9, defpackage.y9.a
                ...
                if (pathSegments != null) {
                    ...
                    if (size == 1) {
                        try {
                            ...
                            throw new FileNotFoundException(hj1.N("Single path segment is not a resource ID: ", uri));
                        }
                    } else if (size == 2) {
                        i = resourcesForApplication.getIdentifier(pathSegments.get(1), pathSegments.get(0), authority);
                    } else {
                        throw new FileNotFoundException(hj1.N("More than two path segments: ", uri));
                    }
                    if (i != 0) {
                        return resourcesForApplication.getDrawable(i);
                    }
                    throw new FileNotFoundException(hj1.N("No resource found for: ", uri));
                }
                throw new FileNotFoundException(hj1.N("No path: ", uri));
            } catch (PackageManager.NameNotFoundException unused2) {
                throw new FileNotFoundException(hj1.N("No package found for authority: ", uri));
            }
        } else {
            throw new FileNotFoundException(hj1.N("No authority: ", uri));
        }
    }
