...
public class AppCompatEditText extends EditText implements o8 {
    private final AppCompatBackgroundHelper mBackgroundTintHelper;
    private final v9 mDefaultOnReceiveContentListener;
    ...
    public InputConnection onCreateInputConnection(EditorInfo editorInfo) {
        ...
        if (onCreateInputConnection2 == null || strArr == null) {
        ...
        k9 createOnCommitContentListener = AppCompatReceiveContentHelper.createOnCommitContentListener(this);
        if (editorInfo == null) {
            throw new IllegalArgumentException("editorInfo must be non-null");
        } else if (createOnCommitContentListener != null) {
            if (i >= 25) {
                j9Var = new i9(onCreateInputConnection2, false, createOnCommitContentListener);
            } else {
                String[] strArr2 = h9.f1349a;
                if (i >= 25) {
                ...
                j9Var = new j9(onCreateInputConnection2, false, createOnCommitContentListener);
            }
            return j9Var;
        } else {
    ...
    public b8 onReceiveContent(b8 b8Var) {
        return this.mDefaultOnReceiveContentListener.a(this, b8Var);
    }
    ...
    public AppCompatEditText(Context context, AttributeSet attributeSet, int i) {
        ...
        this.mDefaultOnReceiveContentListener = new v9();
    }
}
