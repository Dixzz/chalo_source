...
public class SearchView extends LinearLayoutCompat implements c1 {
    ...
    public static class SavedState extends AbsSavedState {
        ...
        public String toString() {
            StringBuilder i0 = hj1.i0("SearchView.SavedState{");
            i0.append(Integer.toHexString(System.identityHashCode(this)));
            i0.append(" isIconified=");
            i0.append(this.isIconified);
            i0.append("}");
            return i0.toString();
        }
    ...
    private void updateSearchAutoComplete() {
        ...
        x9 x9Var = this.mSuggestionsAdapter;
        if (x9Var != null) {
            x9Var.changeCursor(null);
        }
        if (this.mSearchable.getSuggestAuthority() != null) {
    ...
    public x9 getSuggestionsAdapter() {
    ...
    public void setQueryRefinementEnabled(boolean z) {
        ...
        x9 x9Var = this.mSuggestionsAdapter;
        if (x9Var instanceof SuggestionsAdapter) {
            ((SuggestionsAdapter) x9Var).setQueryRefinement(z ? 2 : 1);
        }
    }
    ...
    public void setSuggestionsAdapter(x9 x9Var) {
        this.mSuggestionsAdapter = x9Var;
        this.mSearchSrcTextView.setAdapter(x9Var);
    }
    ...
    public SearchView(Context context, AttributeSet attributeSet, int i) {
        ...
        this.mReleaseCursorRunnable = new Runnable() {
            ...
            public void run() {
                x9 x9Var = SearchView.this.mSuggestionsAdapter;
                if (x9Var instanceof SuggestionsAdapter) {
                    x9Var.changeCursor(null);
                }
            }
        ...
        Drawable drawable = obtainStyledAttributes.getDrawable(R.styleable.SearchView_queryBackground);
        AtomicInteger atomicInteger = r8.f3055a;
        findViewById.setBackground(drawable);
        findViewById2.setBackground(obtainStyledAttributes.getDrawable(R.styleable.SearchView_submitBackground));
