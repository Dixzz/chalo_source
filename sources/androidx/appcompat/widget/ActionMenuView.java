...
public class ActionMenuView extends LinearLayoutCompat implements p1.b, w1 {
    ...
    private p1 mMenu;
    public p1.a mMenuBuilderCallback;
    ...
    public static class ActionMenuPresenterCallback implements v1.a {
    ...
    public class MenuBuilderCallback implements p1.a {
        ...
        public void onMenuModeChange(p1 p1Var) {
            p1.a aVar = ActionMenuView.this.mMenuBuilderCallback;
            if (aVar != null) {
    ...
    public Menu getMenu() {
        if (this.mMenu == null) {
            ...
            this.mMenu = p1Var;
            p1Var.x(new MenuBuilderCallback());
            ActionMenuPresenter actionMenuPresenter = new ActionMenuPresenter(context);
            this.mPresenter = actionMenuPresenter;
            actionMenuPresenter.setReserveOverflow(true);
            ActionMenuPresenter actionMenuPresenter2 = this.mPresenter;
            v1.a aVar = this.mActionMenuPresenterCallback;
            if (aVar == null) {
    ...
    public boolean invokeItem(r1 r1Var) {
        return this.mMenu.s(r1Var, null, 0);
    }
    ...
    public void onMeasure(int i, int i2) {
        ...
        if (!(!this.mFormatItems || (p1Var = this.mMenu) == null || size == this.mFormatItemsWidth)) {
