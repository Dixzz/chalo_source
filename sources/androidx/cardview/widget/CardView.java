...
public class CardView extends FrameLayout {
    ...
    private static final k2 IMPL = new i2();
    private final j2 mCardViewDelegate;
    ...
    public void onMeasure(int i, int i2) {
        ...
        if (!(k2Var instanceof i2)) {
            ...
            if (mode == Integer.MIN_VALUE || mode == 1073741824) {
                i = View.MeasureSpec.makeMeasureSpec(Math.max((int) Math.ceil((double) k2Var.k(this.mCardViewDelegate)), View.MeasureSpec.getSize(i)), mode);
            }
            int mode2 = View.MeasureSpec.getMode(i2);
            if (mode2 == Integer.MIN_VALUE || mode2 == 1073741824) {
                i2 = View.MeasureSpec.makeMeasureSpec(Math.max((int) Math.ceil((double) k2Var.j(this.mCardViewDelegate)), View.MeasureSpec.getSize(i2)), mode2);
            }
    ...
    public CardView(Context context, AttributeSet attributeSet, int i) {
        ...
        IMPL.a(aVar, context, valueOf, dimension, dimension2, f);
    }
}
