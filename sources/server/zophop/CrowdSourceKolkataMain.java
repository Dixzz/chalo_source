...
public class CrowdSourceKolkataMain {
    ...
    private static void startRabbitMQConsumer() {
        try {
            Thread.sleep(1000);
            RabbitMQQueueConsumer rabbitMQQueueConsumer = new RabbitMQQueueConsumer(2);
            rabbitMQQueueConsumer.queue = "kolkata";
            System.out.println("kolkata".toString());
