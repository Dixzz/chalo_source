...
public class CrowdSourceGpsMain {
    ...
    private static void startRabbitMQConsumer() {
        try {
            Thread.sleep(1000);
            RabbitMQQueueConsumer rabbitMQQueueConsumer = new RabbitMQQueueConsumer(100);
            rabbitMQQueueConsumer.queue = "appengine_gps";
            System.out.println("appengine_gps".toString());
            RabbitMQ rabbitMQ = new RabbitMQ(6, Constants.getExchange(), TaskCategory.APPLICATION);
