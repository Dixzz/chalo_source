...
/* compiled from: SuperPassOrderDetails.kt */
public final class SuperPassOrderDetails implements Parcelable {
    public static final Parcelable.Creator<SuperPassOrderDetails> CREATOR = new Creator();
    ...
    /* compiled from: SuperPassOrderDetails.kt */
    public static final class Creator implements Parcelable.Creator<SuperPassOrderDetails> {
        @Override // android.os.Parcelable.Creator
        public final SuperPassOrderDetails createFromParcel(Parcel parcel) {
            n86.e(parcel, "parcel");
            int readInt = parcel.readInt();
            ArrayList arrayList = new ArrayList(readInt);
            for (int i = 0; i != readInt; i++) {
                arrayList.add(parcel.readParcelable(SuperPassOrderDetails.class.getClassLoader()));
            }
            int readInt2 = parcel.readInt();
            ArrayList arrayList2 = new ArrayList(readInt2);
            for (int i2 = 0; i2 != readInt2; i2++) {
                arrayList2.add(parcel.readParcelable(SuperPassOrderDetails.class.getClassLoader()));
            }
            return new SuperPassOrderDetails(arrayList, arrayList2, parcel.readString(), parcel.readString(), parcel.readString(), (RazorPayOrderData) parcel.readParcelable(SuperPassOrderDetails.class.getClassLoader()), parcel.readInt() != 0, parcel.readString(), parcel.readLong(), parcel.readLong());
        }

        @Override // android.os.Parcelable.Creator
        public final SuperPassOrderDetails[] newArray(int i) {
            return new SuperPassOrderDetails[i];
        }
    }
    ...
    public SuperPassOrderDetails(List<? extends CardDetails> list, List<? extends RecentPaymentMethod> list2, String str, String str2, String str3, RazorPayOrderData razorPayOrderData2, boolean z, String str4, long j, long j2) {
    ...
    public static /* synthetic */ SuperPassOrderDetails copy$default(SuperPassOrderDetails superPassOrderDetails, List list, List list2, String str, String str2, String str3, RazorPayOrderData razorPayOrderData2, boolean z, String str4, long j, long j2, int i, Object obj) {
        return superPassOrderDetails.copy((i & 1) != 0 ? superPassOrderDetails.cardDetailsList : list, (i & 2) != 0 ? superPassOrderDetails.recentPaymentMethodsList : list2, (i & 4) != 0 ? superPassOrderDetails.razorPayCustomerId : str, (i & 8) != 0 ? superPassOrderDetails.referenceId : str2, (i & 16) != 0 ? superPassOrderDetails.transactionId : str3, (i & 32) != 0 ? superPassOrderDetails.razorPayOrderData : razorPayOrderData2, (i & 64) != 0 ? superPassOrderDetails.isLPEligible : z, (i & 128) != 0 ? superPassOrderDetails.lPEligibilityResponseId : str4, (i & 256) != 0 ? superPassOrderDetails.bookingTime : j, (i & 512) != 0 ? superPassOrderDetails.expiryTime : j2);
    }
    ...
    public final SuperPassOrderDetails copy(List<? extends CardDetails> list, List<? extends RecentPaymentMethod> list2, String str, String str2, String str3, RazorPayOrderData razorPayOrderData2, boolean z, String str4, long j, long j2) {
        n86.e(list, "cardDetailsList");
        n86.e(list2, "recentPaymentMethodsList");
        n86.e(str3, "transactionId");
        n86.e(razorPayOrderData2, "razorPayOrderData");
        return new SuperPassOrderDetails(list, list2, str, str2, str3, razorPayOrderData2, z, str4, j, j2);
    }
    ...
    public boolean equals(Object obj) {
        ...
        if (!(obj instanceof SuperPassOrderDetails)) {
            return false;
        }
        SuperPassOrderDetails superPassOrderDetails = (SuperPassOrderDetails) obj;
        return n86.a(this.cardDetailsList, superPassOrderDetails.cardDetailsList) && n86.a(this.recentPaymentMethodsList, superPassOrderDetails.recentPaymentMethodsList) && n86.a(this.razorPayCustomerId, superPassOrderDetails.razorPayCustomerId) && n86.a(this.referenceId, superPassOrderDetails.referenceId) && n86.a(this.transactionId, superPassOrderDetails.transactionId) && n86.a(this.razorPayOrderData, superPassOrderDetails.razorPayOrderData) && this.isLPEligible == superPassOrderDetails.isLPEligible && n86.a(this.lPEligibilityResponseId, superPassOrderDetails.lPEligibilityResponseId) && this.bookingTime == superPassOrderDetails.bookingTime && this.expiryTime == superPassOrderDetails.expiryTime;
    }
    ...
    public int hashCode() {
        ...
        return d.a(this.expiryTime) + ((d.a(this.bookingTime) + ((i5 + i) * 31)) * 31);
    }
    ...
    public String toString() {
        StringBuilder i0 = hj1.i0("SuperPassOrderDetails(cardDetailsList=");
