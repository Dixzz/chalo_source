...
public final class SuperPassUserProofUploadFragment extends ul0<tx> {
    public static final /* synthetic */ int m = 0;
    public fa1 g;
    public final j56 h = h.B(this, z86.a(SuperPassPurchaseSharedViewModel.class), new d(this), new e(this));
    public final xi i = new xi(z86.a(d61.class), new f(this));
    public r<String[]> j;
    public r<Intent> k;
    public r<Intent> l;
    ...
    public static final class c extends o86 implements h76<ci> {
        ...
        /* JADX INFO: super call moved to the top of the method (can break code semantics) */
        public c(SuperPassUserProofUploadFragment superPassUserProofUploadFragment, Bundle bundle) {
            super(0);
        ...
        @Override // defpackage.h76
        public ci invoke() {
            return new fa1.a(this.f, this.g);
        }
    }
    ...
    public void f() {
        ...
        bundle.putParcelable("keyProofDetails", ((d61) this.i.getValue()).a());
        this.g = (fa1) ((ai) h.B(this, z86.a(fa1.class), new b(new a(this)), new c(this, bundle))).getValue();
    }
    ...
    public void h() {
        ...
        if (fa1 != null) {
            ...
            if (proofDocumentProps.getFormUrl().length() > 0) {
                ...
                spannableString.setSpan(new c61(this, proofDocumentProps), spannableString.length() - string.length(), spannableString.length(), 33);
                ve activity2 = c();
                if (activity2 != null) {
            ...
            T t9 = this.f;
            n86.c(t9);
            ((tx) t9).h.setOnClickListener(new j51(this, tutorialUrl));
            ...
            if (z) {
                ...
                if (activity3 != null) {
                    ...
                    T t14 = this.f;
                    n86.c(t14);
                    ((tx) t14).d.setOnClickListener(new n51(this, placeHolderImageUrl));
                }
            }
            T t15 = this.f;
            n86.c(t15);
            ((tx) t15).b.setOnClickListener(new k51(this));
    ...
    public final void k() {
        if (c() != null) {
            ed1 ed1 = new ed1("photo chooser launched", Long.MIN_VALUE);
            i(ed1);
            ui1.m0(ed1);
    ...
    public void onAttach(Context context) {
        ...
        r<String[]> registerForActivityResult = registerForActivityResult(new u(), new i51(this));
        n86.d(registerForActivityResult, "registerForActivityResul… }\n            \n        }");
        this.j = registerForActivityResult;
        r<Intent> registerForActivityResult2 = registerForActivityResult(new w(), new h51(this));
        n86.d(registerForActivityResult2, "registerForActivityResul…)\n            }\n        }");
        this.k = registerForActivityResult2;
        r<Intent> registerForActivityResult3 = registerForActivityResult(new w(), new g51(this));
