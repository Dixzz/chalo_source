...
public final class RequestFactory {
    ...
    public static final class Builder {
        ...
        private ci6 parseHeaders(String[] strArr) {
        ...
        private ParameterHandler<?> parseParameter(int i, Type type, @Nullable Annotation[] annotationArr, boolean z) {
            ...
            if (z) {
                try {
                    if (Utils.getRawType(type) == k66.class) {
        ...
        private ParameterHandler<?> parseParameterAnnotation(int i, Type type, Annotation[] annotationArr, Annotation annotation) {
            if (annotation instanceof Url) {
                ...
                if (this.gotUrl) {
                    ...
                    this.gotUrl = true;
                    if (type == di6.class || type == String.class || type == URI.class || ((type instanceof Class) && "android.net.Uri".equals(((Class) type).getName()))) {
                ...
                if (this.isMultipart) {
                    ...
                    if (!value5.isEmpty()) {
                        ci6 c = ci6.g.c("Content-Disposition", hj1.T("form-data; name=\"", value5, "\""), "Content-Transfer-Encoding", part.encoding());
                        if (Iterable.class.isAssignableFrom(rawType8)) {
                            if (type instanceof ParameterizedType) {
                                ...
                                if (!gi6.c.class.isAssignableFrom(Utils.getRawType(parameterUpperBound4))) {
                                    return new ParameterHandler.Part(this.method, i, c, this.retrofit.requestBodyConverter(parameterUpperBound4, annotationArr, this.methodAnnotations)).iterable();
                                }
                            ...
                            if (!gi6.c.class.isAssignableFrom(boxIfPrimitive)) {
                                return new ParameterHandler.Part(this.method, i, c, this.retrofit.requestBodyConverter(boxIfPrimitive, annotationArr, this.methodAnnotations)).array();
                            }
                            throw Utils.parameterError(this.method, i, "@Part parameters using the MultipartBody.Part must not include a part name in the annotation.", new Object[0]);
                        } else if (!gi6.c.class.isAssignableFrom(rawType8)) {
                            return new ParameterHandler.Part(this.method, i, c, this.retrofit.requestBodyConverter(type, annotationArr, this.methodAnnotations));
                        } else {
                            throw Utils.parameterError(this.method, i, "@Part parameters using the MultipartBody.Part must not include a part name in the annotation.", new Object[0]);
                        }
                        ...
                        if (!(type instanceof ParameterizedType)) {
                            throw Utils.parameterError(this.method, i, rawType8.getSimpleName() + " must include generic type (e.g., " + rawType8.getSimpleName() + "<String>)", new Object[0]);
                        } else if (gi6.c.class.isAssignableFrom(Utils.getRawType(Utils.getParameterUpperBound(0, (ParameterizedType) type)))) {
                        ...
                        if (gi6.c.class.isAssignableFrom(rawType8.getComponentType())) {
                    ...
                    if (Map.class.isAssignableFrom(rawType9)) {
                        ...
                        if (supertype4 instanceof ParameterizedType) {
                            ...
                            if (String.class == parameterUpperBound5) {
                                ...
                                if (!gi6.c.class.isAssignableFrom(Utils.getRawType(parameterUpperBound6))) {
                ...
                for (int i2 = i - 1; i2 >= 0; i2--) {
                    ...
                    if ((parameterHandler instanceof ParameterHandler.Tag) && ((ParameterHandler.Tag) parameterHandler).cls.equals(rawType10)) {
                        ...
                        StringBuilder i0 = hj1.i0("@Tag type ");
                        i0.append(rawType10.getName());
                        i0.append(" is duplicate of parameter #");
                        i0.append(i2 + 1);
                        i0.append(" and would always overwrite its value.");
                        throw Utils.parameterError(method2, i, i0.toString(), new Object[0]);
                    }
                }
    ...
    public ji6 create(Object[] objArr) throws IOException {
        ParameterHandler<?>[] parameterHandlerArr = this.parameterHandlers;
        ...
        if (length == parameterHandlerArr.length) {
            ...
            ji6.a aVar = requestBuilder.get();
            aVar.h(Invocation.class, new Invocation(this.method, arrayList));
            return aVar.b();
        }
        throw new IllegalArgumentException(hj1.X(hj1.j0("Argument count (", length, ") doesn't match expected count ("), parameterHandlerArr.length, ")"));
    }
}
