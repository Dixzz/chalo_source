...
public class TrueProfile implements Parcelable {
    ...
    public static final Parcelable.Creator<TrueProfile> CREATOR = new a();
    ...
    public static final class Builder {
        ...
        public TrueProfile build() {
            return new TrueProfile(this, (a) null);
        }
    ...
    public static class a implements Parcelable.Creator<TrueProfile> {
        /* Return type fixed from 'java.lang.Object' to match base method */
        @Override // android.os.Parcelable.Creator
        public TrueProfile createFromParcel(Parcel parcel) {
            return new TrueProfile(parcel, (a) null);
        }
    ...
    public /* synthetic */ TrueProfile(Parcel parcel, a aVar) {
        this(parcel);
    }
    ...
    public /* synthetic */ TrueProfile(Builder builder, a aVar) {
        this(builder);
    }
