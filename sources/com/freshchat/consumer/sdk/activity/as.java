...
public class as extends WebViewClient {
    ...
    private String t() {
        return hj1.J("javascript:(function(){ document.body.style.paddingBottom = '", (int) this.pI.getResources().getDimension(R.dimen.freshchat_faq_content_padding_bottom), "px'})();");
    }

    public void onPageFinished(WebView webView, String str) {
        super.onPageFinished(webView, str);
        FAQDetailsActivity.c(this.pI).postDelayed(new at(this), 500);
        webView.loadUrl(t());
    }
