...
public class d {
    ...
    private static Map<String, String> e(Map<String, String> map) {
        ...
        for (String str : map.keySet()) {
            ...
            boolean z2 = false;
            if (!av.aO(str)) {
                ai.e("FRESHCHAT_WARNING", c.USER_PROPERTY_KEY_LENGTH_ERROR.toString().replace("{{user_property_key_placeholder}}", str).replace("{{user_property_charecter_limit_placeholder}}", String.valueOf(32)));
                z = false;
            }
            String str2 = map.get(str);
            if (!av.aN(str2)) {
                ai.e("FRESHCHAT_WARNING", c.USER_PROPERTY_VALUE_ERROR.toString().replace("{{user_property_key_placeholder}}", str).replace("{{user_property_charecter_limit_placeholder}}", String.valueOf(256)));
            } else {
                z2 = z;
            }
            if (z2) {
