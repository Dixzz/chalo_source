...
public class a {
    ...
    public static String A(Context context) {
        ...
        FCLocale bC = i.bC();
        String a2 = a(a(a("{{app_domain}}/app/services/app/{{app_alias}}/channel/v2?t={{app_key}}&locale={{locale}}", i).replace("{{locale}}", bc), "since", bB), "lastLocaleId", bC != null ? String.valueOf(bC.getLocaleId()) : null);
    ...
    public static String a(Context context, int i, String str, List<String> list) {
        ...
        return as.a(a2) ? a(replace, "tags", a2) : replace;
    }
    ...
    public static String a(Context context, int i, List<String> list) {
        ...
        return a2 != null ? a(replace, "tags", a2) : replace;
    }

    public static String a(Context context, String str, int i) {
        return a("{{app_domain}}/app/translation/services/app/{{app_alias}}/user/{{user_alias}}/conversations?t={{app_key}}&messageAfter={{message_after}}&src={{src}}", e.i(context)).replace("{{message_after}}", str).replace("{{src}}", String.valueOf(i));
    }
    ...
    public static String z(Context context) {
        e i = e.i(context);
        String a2 = a(a(a("{{app_domain}}/app/services/app/{{app_alias}}/sdk/faq/v2/category?t={{app_key}}&platform=android", i), "since", i.bt()), AnalyticsConstants.LOCALE, ah.bc(context));
        FCLocale bu = i.bu();
        if (bu != null) {
            a2 = a(a2, "lastLocaleId", bu.getLocaleId());
        }
