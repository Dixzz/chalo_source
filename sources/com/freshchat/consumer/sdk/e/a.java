...
public class a {
    ...
    public void a(ConversationReadStatus conversationReadStatus) throws DeletedException {
        try {
            d c = new c(this.context).c(com.freshchat.consumer.sdk.j.a.B(this.context), new ab().toJson(conversationReadStatus));
            String a2 = c.a(c);
            if (!a(c.getStatusCode(), a2)) {
                if (c.getStatusCode() != 200) {
                    throw new b("sc: " + c.getStatusCode() + " m: " + a2);
                }
            }
        } catch (DeletedException e) {
            throw e;
    ...
    public boolean a(CsatResponseRequest csatResponseRequest, String str, String str2) throws DeletedException {
        try {
            d c = new c(this.context).c(com.freshchat.consumer.sdk.j.a.b(this.context, str, str2), new ab().toJson(csatResponseRequest));
            int statusCode = c.getStatusCode();
            return !a(statusCode, c.a(c)) && statusCode == 201;
        } catch (DeletedException e) {
            throw e;
        } catch (Exception e2) {
    ...
    public boolean a(String str, String str2, JSONObject jSONObject) throws DeletedException {
        try {
            d d = new c(this.context).d(com.freshchat.consumer.sdk.j.a.a(this.context, str, str2), jSONObject.toString());
            if (!a(d.getStatusCode(), c.a(d))) {
    ...
    public ValidateJwtIdTokenResponse aZ(String str) {
        try {
            ...
            d c = cVar.c(bv, jSONObject.toString());
            int statusCode = c.getStatusCode();
            String a2 = c.a(c);
            if (!a(statusCode, a2)) {
                if (statusCode != 200) {
    ...
    public UserResponse c(UserRequest userRequest) throws DeletedException {
        ...
        try {
            ...
            c cVar = new c(this.context);
            ab abVar = new ab();
            d c = cVar.c(bw, abVar.toJson(userRequest));
            int statusCode = c.getStatusCode();
            String a2 = c.a(c);
            if (!a(statusCode, a2)) {
                if (statusCode == 200) {
    ...
    public UploadInboundEventsResponse h(String str, String str2) throws DeletedException {
        try {
            d c = new c(this.context).c(com.freshchat.consumer.sdk.j.a.G(this.context, str2), str);
            int statusCode = c.getStatusCode();
            String a2 = c.a(c);
            if (!a(statusCode, a2)) {
                if (statusCode != 202) {
    ...
    public boolean q(long j) throws DeletedException {
        try {
            ...
            e eVar = new e(context2, com.freshchat.consumer.sdk.j.a.b(context2, j), FirebasePerformance.HttpMethod.PUT);
