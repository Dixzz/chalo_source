...
public class DeepLinkUtils {
                ...
                if (f(uri)) {
                    ...
                    if (a2 instanceof m) {
                        ...
                        if (j > 0) {
                            ...
                            String queryParameter = uri.getQueryParameter(ProductPromotionsObject.KEY_TITLE);
    ...
    private static Intent f(Context context, Uri uri) {
        ...
        Intent N0 = hj1.N0(context, FAQDetailsActivity.class, "article_id", g);
        N0.putExtra("category_id", l);
        return N0;
    }
    ...
    private static Collection<String> k(Uri uri) {
        ...
        return k.d(Arrays.asList(queryParameter.split(",")));
    }
