...
public class CarouselCardView extends CardView {
    ...
    public void hm() {
        ...
        if (as.a(ho)) {
            ...
            FreshchatImageLoaderRequest dM = new FreshchatImageLoaderRequest.a(ho).a(this.nO.I(dimensionPixelSize), this.nO.J(dimensionPixelSize)).G(j).H(j2).dM();
        ...
        if (hp == i.a.CARD_WITH_CALLBACK_AND_VIEW_OPTION) {
            com.freshchat.consumer.sdk.b.i.b(this.nM);
            this.nM.setText(this.nO.bm(string2));
            this.nK.setOrientation(!this.nO.x(string, string2));
    ...
    public void setUploadedStateDrawable(Drawable drawable) {
        ImageView imageView;
        if (drawable != null && (imageView = this.nF) != null) {
