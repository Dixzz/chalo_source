...
public final class DefaultDateTypeAdapter extends TypeAdapter<Date> {
    ...
    public String toString() {
        ...
        if (dateFormat instanceof SimpleDateFormat) {
            StringBuilder i0 = hj1.i0("DefaultDateTypeAdapter(");
            i0.append(((SimpleDateFormat) dateFormat).toPattern());
            i0.append(')');
            return i0.toString();
        }
        StringBuilder i02 = hj1.i0("DefaultDateTypeAdapter(");
        i02.append(dateFormat.getClass().getSimpleName());
        i02.append(')');
        return i02.toString();
    }
