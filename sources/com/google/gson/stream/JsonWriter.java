...
public class JsonWriter implements Closeable, Flushable {
    ...
    public JsonWriter(Writer writer) {
        push(6);
        this.separator = ProductDiscountsObject.KEY_DELIMITER;
    ...
    private JsonWriter close(int i, int i2, String str) throws IOException {
        ...
        if (peek != i2 && peek != i) {
            ...
            StringBuilder i0 = hj1.i0("Dangling name: ");
            i0.append(this.deferredName);
    ...
    public JsonWriter nullValue() throws IOException {
        ...
        beforeValue();
        this.out.write(AnalyticsConstants.NULL);
        return this;
    }
