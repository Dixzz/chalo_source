...
public class JsonReader implements Closeable {
        ...
        JsonReaderInternalAccess.INSTANCE = new JsonReaderInternalAccess() {
            ...
            public void promoteNameToValue(JsonReader jsonReader) throws IOException {
                ...
                if (i == 13) {
                    ...
                    StringBuilder i0 = hj1.i0("Expected a name but was ");
                    i0.append(jsonReader.peek());
                    i0.append(jsonReader.locationString());
        ...
        while (true) {
            if (i == i2) {
                ...
                if (fillBuffer(1)) {
                    ...
                    StringBuilder i0 = hj1.i0("End of input");
                    i0.append(locationString());
                    ...
                    while (i5 < i6) {
                        ...
                        if (c3 < '0' || c3 > '9') {
                            if (c3 >= 'a' && c3 <= 'f') {
                                ...
                                StringBuilder i0 = hj1.i0("\\u");
                                i0.append(new String(this.buffer, this.pos, 4));
                                throw new NumberFormatException(i0.toString());
                            } else {
                                i2 = c3 - 'A';
                            }
                            i = i2 + 10;
    ...
    private IOException syntaxError(String str) throws IOException {
        ...
        i0.append(locationString());
        throw new MalformedJsonException(i0.toString());
    }
    ...
    public void beginArray() throws IOException {
        ...
        StringBuilder i0 = hj1.i0("Expected BEGIN_ARRAY but was ");
        i0.append(peek());
        i0.append(locationString());
        throw new IllegalStateException(i0.toString());
    }
    ...
    public void beginObject() throws IOException {
        ...
        StringBuilder i0 = hj1.i0("Expected BEGIN_OBJECT but was ");
        i0.append(peek());
        i0.append(locationString());
        throw new IllegalStateException(i0.toString());
    }
    ...
    public void endArray() throws IOException {
        ...
        StringBuilder i0 = hj1.i0("Expected END_ARRAY but was ");
        i0.append(peek());
        i0.append(locationString());
        throw new IllegalStateException(i0.toString());
    }
    ...
    public void endObject() throws IOException {
        ...
        StringBuilder i0 = hj1.i0("Expected END_OBJECT but was ");
        i0.append(peek());
        i0.append(locationString());
        throw new IllegalStateException(i0.toString());
    }
    ...
    public boolean nextBoolean() throws IOException {
        ...
        if (i == 5) {
            ...
            StringBuilder i0 = hj1.i0("Expected a boolean but was ");
            i0.append(peek());
            i0.append(locationString());
            throw new IllegalStateException(i0.toString());
        }
    ...
    public double nextDouble() throws IOException {
        ...
        if (i == 16) {
            ...
            StringBuilder i0 = hj1.i0("Expected a double but was ");
            i0.append(peek());
            i0.append(locationString());
            throw new IllegalStateException(i0.toString());
        }
    ...
    public int nextInt() throws IOException {
        ...
        if (i == 15) {
            ...
            StringBuilder i0 = hj1.i0("Expected an int but was ");
            i0.append(this.peekedLong);
            i0.append(locationString());
            throw new NumberFormatException(i0.toString());
        }
        if (i == 16) {
            ...
            StringBuilder i02 = hj1.i0("Expected an int but was ");
            i02.append(peek());
            i02.append(locationString());
        ...
        StringBuilder i03 = hj1.i0("Expected an int but was ");
        i03.append(this.peekedString);
        i03.append(locationString());
        throw new NumberFormatException(i03.toString());
    }
    ...
    public long nextLong() throws IOException {
        ...
        if (i == 16) {
            ...
            StringBuilder i0 = hj1.i0("Expected a long but was ");
            i0.append(peek());
            i0.append(locationString());
            throw new IllegalStateException(i0.toString());
        }
        ...
        StringBuilder i02 = hj1.i0("Expected a long but was ");
        i02.append(this.peekedString);
        i02.append(locationString());
        throw new NumberFormatException(i02.toString());
    }
    ...
    public void nextNull() throws IOException {
        ...
        StringBuilder i0 = hj1.i0("Expected null but was ");
        i0.append(peek());
        i0.append(locationString());
        throw new IllegalStateException(i0.toString());
    }
    ...
    public String nextString() throws IOException {
        ...
        if (i == 10) {
            ...
            StringBuilder i0 = hj1.i0("Expected a string but was ");
            i0.append(peek());
            i0.append(locationString());
            throw new IllegalStateException(i0.toString());
        }
    ...
    public void skipValue() throws IOException {
        ...
        int i4 = i3 - 1;
        iArr[i4] = iArr[i4] + 1;
        this.pathNames[i3 - 1] = AnalyticsConstants.NULL;
    }
