...
public final class LinkedHashTreeMap<K, V> extends AbstractMap<K, V> implements Serializable, Map {
    ...
    private static final Comparator<Comparable> NATURAL_ORDER = new Object() {
        ...
        public /* synthetic */ Comparator<Comparable> reversed() {
        ...
        @Override // j$.util.Comparator, java.util.Comparator
        public /* synthetic */ java.util.Comparator<Comparable> thenComparing(java.util.Comparator<? super Comparable> comparator) {
    ...
    public Node<K, V> find(K k, boolean z) {
        ...
        Node<K, V> node2;
        int i2;
        java.util.Comparator<? super K> comparator2 = this.comparator;
        Node<K, V>[] nodeArr = this.table;
    ...
    public LinkedHashTreeMap(java.util.Comparator<? super K> comparator2) {
        this.size = 0;
        this.modCount = 0;
