...
public class ISO8601Utils {
    ...
    private static int parseInt(String str, int i, int i2) throws NumberFormatException {
        ...
        if (i < i2) {
            ...
            if (digit >= 0) {
                ...
                StringBuilder i0 = hj1.i0("Invalid number: ");
                i0.append(str.substring(i, i2));
        ...
        while (i4 < i2) {
            ...
            if (digit2 >= 0) {
                ...
                StringBuilder i02 = hj1.i0("Invalid number: ");
                i02.append(str.substring(i, i2));
    ...
    public static String format(Date date, boolean z, TimeZone timeZone) {
        ...
        if (offset != 0) {
            int i = offset / ConnectionFactory.DEFAULT_CONNECTION_TIMEOUT;
