...
public final class AutoValue_PersistedInstallationEntry extends PersistedInstallationEntry {
    ...
    public static final class Builder extends PersistedInstallationEntry.Builder {
        ...
        public PersistedInstallationEntry build() {
            ...
            if (this.expiresInSecs == null) {
                str = hj1.S(str, " expiresInSecs");
            }
            if (this.tokenCreationEpochInSecs == null) {
                str = hj1.S(str, " tokenCreationEpochInSecs");
            }
            if (str.isEmpty()) {
    ...
    public String toString() {
        StringBuilder i0 = hj1.i0("PersistedInstallationEntry{firebaseInstallationId=");
        i0.append(this.firebaseInstallationId);
        i0.append(", registrationStatus=");
        i0.append(this.registrationStatus);
        i0.append(", authToken=");
        i0.append(this.authToken);
        i0.append(", refreshToken=");
        i0.append(this.refreshToken);
        i0.append(", expiresInSecs=");
        i0.append(this.expiresInSecs);
        i0.append(", tokenCreationEpochInSecs=");
        i0.append(this.tokenCreationEpochInSecs);
        i0.append(", fisError=");
        return hj1.a0(i0, this.fisError, "}");
    }
