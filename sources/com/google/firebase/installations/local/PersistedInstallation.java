...
public class PersistedInstallation {
    ...
    public PersistedInstallation(FirebaseApp firebaseApp2) {
        ...
        StringBuilder i0 = hj1.i0("PersistedInstallation.");
        i0.append(firebaseApp2.getPersistenceKey());
        i0.append(".json");
        this.dataFile = new File(filesDir, i0.toString());
    ...
    public PersistedInstallationEntry insertOrUpdatePersistedInstallationEntry(PersistedInstallationEntry persistedInstallationEntry) {
        try {
            ...
            fileOutputStream.write(jSONObject.toString().getBytes(StringRpcServer.STRING_ENCODING));
