...
public final class zzai {
    public static Status zza(String str) {
        ...
        if (TextUtils.isEmpty(str)) {
            return new Status(FirebaseError.ERROR_INTERNAL_ERROR, null);
        }
        String[] split = str.split(ProductDiscountsObject.KEY_DELIMITER, 2);
    ...
    private static Status zzb(String str, String str2) {
        ...
        return new Status(FirebaseError.ERROR_INTERNAL_ERROR, hj1.b0(new StringBuilder(str.length() + 1 + str2.length()), str, ProductDiscountsObject.KEY_DELIMITER, str2));
    }
}
