...
public class PhoneAuthProvider {
    ...
    public static class ForceResendingToken extends AbstractSafeParcelable {
        ...
        public final void writeToParcel(Parcel parcel, int i) {
            gj1.H1(parcel, gj1.o1(parcel, 20293));
        }
    }

    /* compiled from: com.google.firebase:firebase-auth@@20.0.1 */
    public static abstract class OnVerificationStateChangedCallbacks {
        private static final wa2 zza = new wa2("PhoneAuthProvider", new String[0]);
    ...
    public static void verifyPhoneNumber(PhoneAuthOptions phoneAuthOptions) {
        Objects.requireNonNull(phoneAuthOptions, "null reference");
