...
public final class PhoneAuthOptions {
    ...
    public static final class Builder {
        ...
        public PhoneAuthOptions build() {
            gj1.l(this.zza, "FirebaseAuth instance cannot be null");
            gj1.l(this.zzc, "You must specify an auto-retrieval timeout; please call #setTimeout()");
            gj1.l(this.zzd, "You must specify callbacks on your PhoneAuthOptions. Please call #setCallbacks()");
            gj1.l(this.zzf, "You must specify an Activity on your PhoneAuthOptions. Please call #setActivity()");
            this.zze = aj4.f170a;
            ...
            if (multiFactorSession == null) {
                gj1.i(this.zzb, "The given phoneNumber is empty. Please set a non-empty phone number with #setPhoneNumber()");
                gj1.c(!this.zzj, "You cannot require sms validation without setting a multi-factor session.");
                if (this.zzi == null) {
                    z = true;
                }
                gj1.c(z, "A phoneMultiFactorInfo must be set for second factor sign-in.");
            } else if (((zzag) multiFactorSession).zze()) {
                gj1.j(this.zzb);
                if (this.zzi == null) {
                    z = true;
                }
                gj1.c(z, "Invalid MultiFactorSession - use the getSession method in MultiFactorResolver to get a valid sign-in session.");
            } else {
                gj1.c(this.zzi != null, "A phoneMultiFactorInfo must be set for second factor sign-in.");
                if (this.zzb == null) {
                    z = true;
                }
                gj1.c(z, "A phone number must not be set for MFA sign-in. A PhoneMultiFactorInfo should be set instead.");
            }
