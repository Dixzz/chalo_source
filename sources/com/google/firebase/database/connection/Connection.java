...
public class Connection implements WebsocketConnection.Delegate {
    ...
    public Connection(ConnectionContext connectionContext, HostInfo hostInfo2, String str, Delegate delegate2, String str2) {
        ...
        this.logger = new LogWrapper(connectionContext.getLogger(), "Connection", hj1.M("conn_", j));
    ...
    private void onControlMessage(Map<String, Object> map) {
        if (this.logger.logsDebug()) {
            ...
            StringBuilder i0 = hj1.i0("Got control message: ");
        ...
        try {
            ...
            if (this.logger.logsDebug()) {
                ...
                StringBuilder i02 = hj1.i0("Failed to parse control message: ");
                i02.append(e.toString());
                logWrapper4.debug(i02.toString(), new Object[0]);
            }
            close();
        }
    }
    ...
    private void onDataMessage(Map<String, Object> map) {
        if (this.logger.logsDebug()) {
            LogWrapper logWrapper = this.logger;
            StringBuilder i0 = hj1.i0("received data message: ");
            i0.append(map.toString());
            logWrapper.debug(i0.toString(), new Object[0]);
        }
    ...
    private void onReset(String str) {
        if (this.logger.logsDebug()) {
            LogWrapper logWrapper = this.logger;
            StringBuilder i0 = hj1.i0("Got a reset; killing connection to ");
            i0.append(this.hostInfo.getHost());
            i0.append("; Updating internalHost to ");
            i0.append(str);
            logWrapper.debug(i0.toString(), new Object[0]);
        }
    ...
    public void onMessage(Map<String, Object> map) {
        try {
            ...
            if (this.logger.logsDebug()) {
                LogWrapper logWrapper3 = this.logger;
                StringBuilder i0 = hj1.i0("Failed to parse server message: ");
                i0.append(e.toString());
                logWrapper3.debug(i0.toString(), new Object[0]);
            }
            close();
        }
    }
