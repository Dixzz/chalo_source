...
public class ViewProcessor {
    ...
    public static /* synthetic */ class AnonymousClass2 {
        ...
        static {
            /*
                com.google.firebase.database.core.operation.Operation.OperationType.values()
                r0 = 4
                int[] r1 = new int[r0]
                com.google.firebase.database.core.view.ViewProcessor.AnonymousClass2.$SwitchMap$com$google$firebase$database$core$operation$Operation$OperationType = r1
                r2 = 1
                com.google.firebase.database.core.operation.Operation$OperationType r3 = com.google.firebase.database.core.operation.Operation.OperationType.Overwrite     // Catch:{ NoSuchFieldError -> 0x000e }
                r3 = 0
                r1[r3] = r2     // Catch:{ NoSuchFieldError -> 0x000e }
            L_0x000e:
                r1 = 2
                int[] r3 = com.google.firebase.database.core.view.ViewProcessor.AnonymousClass2.$SwitchMap$com$google$firebase$database$core$operation$Operation$OperationType     // Catch:{ NoSuchFieldError -> 0x0015 }
                com.google.firebase.database.core.operation.Operation$OperationType r4 = com.google.firebase.database.core.operation.Operation.OperationType.Merge     // Catch:{ NoSuchFieldError -> 0x0015 }
                r3[r2] = r1     // Catch:{ NoSuchFieldError -> 0x0015 }
            L_0x0015:
                r2 = 3
                int[] r3 = com.google.firebase.database.core.view.ViewProcessor.AnonymousClass2.$SwitchMap$com$google$firebase$database$core$operation$Operation$OperationType     // Catch:{ NoSuchFieldError -> 0x001c }
                com.google.firebase.database.core.operation.Operation$OperationType r4 = com.google.firebase.database.core.operation.Operation.OperationType.AckUserWrite     // Catch:{ NoSuchFieldError -> 0x001c }
                r3[r1] = r2     // Catch:{ NoSuchFieldError -> 0x001c }
            L_0x001c:
                int[] r1 = com.google.firebase.database.core.view.ViewProcessor.AnonymousClass2.$SwitchMap$com$google$firebase$database$core$operation$Operation$OperationType     // Catch:{ NoSuchFieldError -> 0x0022 }
                com.google.firebase.database.core.operation.Operation$OperationType r3 = com.google.firebase.database.core.operation.Operation.OperationType.ListenComplete     // Catch:{ NoSuchFieldError -> 0x0022 }
    ...
    private ViewCache applyServerOverwrite(ViewCache viewCache, Path path, Node node, WriteTreeRef writeTreeRef, Node node2, boolean z, ChildChangeAccumulator childChangeAccumulator) {
        ...
        boolean z2 = true;
        if (path.isEmpty()) {
            indexedNode = nodeFilter.updateFullNode(serverCache.getIndexedNode(), IndexedNode.from(node, nodeFilter.getIndex()), null);
            ...
            indexedNode = nodeFilter.updateFullNode(serverCache.getIndexedNode(), serverCache.getIndexedNode().updateChild(front2, serverCache.getNode().getImmediateChild(front2).updateChild(path.popFront(), node)), null);
        }
        z2 = false;
    ...
    public ProcessorResult applyOperation(ViewCache viewCache, Operation operation, WriteTreeRef writeTreeRef, Node node) {
        ...
        if (ordinal == 0) {
            ...
            StringBuilder i0 = hj1.i0("Unknown operation: ");
            i0.append(operation.getType());
    ...
    public ViewCache revertUserWrite(ViewCache viewCache, Path path, WriteTreeRef writeTreeRef, Node node, ChildChangeAccumulator childChangeAccumulator) {
        ...
        if (path.isEmpty() || path.getFront().isPriorityChildName()) {
            ...
            if (calcCompleteChild != null) {
                indexedNode = this.filter.updateChild(indexedNode, front, calcCompleteChild, path.popFront(), writeTreeCompleteChildSource, childChangeAccumulator);
