...
public class Change {
    ...
    public static Change valueChange(IndexedNode indexedNode2) {
        return new Change(Event.EventType.VALUE, indexedNode2, null, null, null);
    }
    ...
    public String toString() {
        StringBuilder i0 = hj1.i0("Change: ");
        i0.append(this.eventType);
        i0.append(" ");
        i0.append(this.childKey);
        return i0.toString();
    }

    public static Change childAddedChange(ChildKey childKey2, IndexedNode indexedNode2) {
        return new Change(Event.EventType.CHILD_ADDED, indexedNode2, childKey2, null, null);
    }

    public static Change childMovedChange(ChildKey childKey2, IndexedNode indexedNode2) {
        return new Change(Event.EventType.CHILD_MOVED, indexedNode2, childKey2, null, null);
    }

    public static Change childRemovedChange(ChildKey childKey2, IndexedNode indexedNode2) {
        return new Change(Event.EventType.CHILD_REMOVED, indexedNode2, childKey2, null, null);
    }

    public static Change childChangedChange(ChildKey childKey2, IndexedNode indexedNode2, IndexedNode indexedNode3) {
        return new Change(Event.EventType.CHILD_CHANGED, indexedNode2, childKey2, null, indexedNode3);
    }
}
