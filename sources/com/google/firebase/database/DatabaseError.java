...
public class DatabaseError {
    ...
    static {
        ...
        hashMap2.put(AnalyticsConstants.FAILURE, -2);
    ...
    public static DatabaseError fromCode(int i) {
        ...
        throw new IllegalArgumentException(hj1.I("Invalid Firebase Database error code: ", i));
    }
    ...
    public DatabaseException toException() {
        StringBuilder i0 = hj1.i0("Firebase Database error: ");
        i0.append(this.message);
        return new DatabaseException(i0.toString());
    }

    public String toString() {
        StringBuilder i0 = hj1.i0("DatabaseError: ");
        i0.append(this.message);
        return i0.toString();
    }
