...
public class GmsRpc {
    ...
    private final FirebaseApp f663app;
    ...
    private yi4<String> extractResponseWhenComplete(yi4<Bundle> yi4) {
        return yi4.i(GmsRpc$$Lambda$0.$instance, new GmsRpc$$Lambda$1(this));
    }

    private String getHashedFirebaseAppName() {
        try {
            return base64UrlSafe(MessageDigest.getInstance("SHA-1").digest(this.f663app.getName().getBytes()));
    ...
    private Bundle setDefaultAttributesToBundle(String str, String str2, String str3, Bundle bundle) {
        ...
        bundle.putString("gmp_app_id", this.f663app.getOptions().getApplicationId());
    ...
    public yi4<?> deleteToken(String str) {
        Bundle bundle = new Bundle();
        bundle.putString("delete", "1");
        return extractResponseWhenComplete(startRpc(str, Metadata.getDefaultSenderId(this.f663app), "*", bundle));
    }

    public yi4<String> getToken(String str) {
        return extractResponseWhenComplete(startRpc(str, Metadata.getDefaultSenderId(this.f663app), "*", new Bundle()));
    }
