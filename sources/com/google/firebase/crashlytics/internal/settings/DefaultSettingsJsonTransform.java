...
public class DefaultSettingsJsonTransform implements SettingsJsonTransform {
    private static AppSettingsData buildAppDataFrom(JSONObject jSONObject) throws JSONException {
        return new AppSettingsData(jSONObject.getString("status"), jSONObject.getString("url"), jSONObject.getString(SettingsJsonConstants.APP_REPORTS_URL_KEY), jSONObject.getString(SettingsJsonConstants.APP_NDK_REPORTS_URL_KEY), jSONObject.optBoolean(SettingsJsonConstants.APP_UPDATE_REQUIRED_KEY, false));
    }
    ...
    public static Settings defaultSettings(CurrentTimeProvider currentTimeProvider) {
        ...
        return new SettingsData(getExpiresAtFrom(currentTimeProvider, 3600, jSONObject), null, buildSessionDataFrom(jSONObject), buildFeaturesSessionDataFrom(jSONObject), 0, SettingsJsonConstants.SETTINGS_CACHE_DURATION_DEFAULT);
    }
