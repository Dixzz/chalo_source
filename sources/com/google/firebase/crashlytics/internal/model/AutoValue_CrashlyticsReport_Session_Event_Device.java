...
public final class AutoValue_CrashlyticsReport_Session_Event_Device extends CrashlyticsReport.Session.Event.Device {
    ...
    public static final class Builder extends CrashlyticsReport.Session.Event.Device.Builder {
        ...
        public CrashlyticsReport.Session.Event.Device build() {
            ...
            if (this.proximityOn == null) {
                str = hj1.S(str, " proximityOn");
            }
            if (this.orientation == null) {
                str = hj1.S(str, " orientation");
            }
            if (this.ramUsed == null) {
                str = hj1.S(str, " ramUsed");
            }
            if (this.diskUsed == null) {
                str = hj1.S(str, " diskUsed");
            }
            if (str.isEmpty()) {
    ...
    public String toString() {
        StringBuilder i0 = hj1.i0("Device{batteryLevel=");
        i0.append(this.batteryLevel);
        i0.append(", batteryVelocity=");
        i0.append(this.batteryVelocity);
        i0.append(", proximityOn=");
        i0.append(this.proximityOn);
        i0.append(", orientation=");
        i0.append(this.orientation);
        i0.append(", ramUsed=");
        i0.append(this.ramUsed);
        i0.append(", diskUsed=");
        i0.append(this.diskUsed);
        i0.append("}");
        return i0.toString();
    }
