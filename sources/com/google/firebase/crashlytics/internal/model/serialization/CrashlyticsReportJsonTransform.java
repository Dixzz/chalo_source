...
public class CrashlyticsReportJsonTransform {
    ...
    private static CrashlyticsReport.Session.Application parseApp(JsonReader jsonReader) throws IOException {
        ...
        while (jsonReader.hasNext()) {
            ...
            switch (nextName.hashCode()) {
                case -1618432855:
                    if (nextName.equals(CheckForUpdatesResponseTransform.IDENTIFIER)) {
                        c = 0;
                        break;
                    }
                    break;
    ...
    public static CrashlyticsReport.CustomAttribute parseCustomAttribute(JsonReader jsonReader) throws IOException {
        ...
        while (jsonReader.hasNext()) {
            String nextName = jsonReader.nextName();
            nextName.hashCode();
            if (nextName.equals(AnalyticsConstants.KEY)) {
    ...
    public static CrashlyticsReport.Session.Event parseEvent(JsonReader jsonReader) throws IOException {
        ...
        while (jsonReader.hasNext()) {
            ...
            switch (nextName.hashCode()) {
                case -1335157162:
                    if (nextName.equals(AnalyticsConstants.DEVICE)) {
                        c = 0;
                        break;
                    }
                    break;
    ...
    private static CrashlyticsReport.Session.Event.Application parseEventApp(JsonReader jsonReader) throws IOException {
        ...
        while (jsonReader.hasNext()) {
            ...
            switch (nextName.hashCode()) {
                case -1332194002:
                    if (nextName.equals(ProductPromotionsObject.KEY_BACKGROUND)) {
                        c = 0;
                        break;
                    }
                    break;
                case -1090974952:
                    ...
                    break;
                case 555169704:
                    if (nextName.equals(SessionEventTransform.CUSTOM_ATTRIBUTES)) {
                        c = 2;
                        break;
                    }
                    break;
        ...
        while (jsonReader.hasNext()) {
            ...
            switch (nextName.hashCode()) {
                ...
                case -1335157162:
                    ...
                    break;
                case -1291329255:
                    if (nextName.equals(AnalyticsConstants.EVENTS)) {
                        c = 4;
                        break;
                    }
                    break;
                case 3556:
                    if (nextName.equals(User.DEVICE_META_OS_NAME)) {
                        c = 5;
                        break;
                    }
                    break;
                case 96801:
                    ...
                    break;
                case 3599307:
                    if (nextName.equals(LoggingConstants.USER)) {
                        c = 7;
                        break;
                    }
                    break;
