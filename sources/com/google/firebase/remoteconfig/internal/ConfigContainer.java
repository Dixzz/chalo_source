...
public class ConfigContainer {
    ...
    public static ConfigContainer copyOf(JSONObject jSONObject) throws JSONException {
        return new ConfigContainer(jSONObject.getJSONObject(CONFIGS_KEY), new Date(jSONObject.getLong(FETCH_TIME_KEY)), jSONObject.getJSONArray(ABT_EXPERIMENTS_KEY), jSONObject.getJSONObject(PERSONALIZATION_METADATA_KEY));
    }
