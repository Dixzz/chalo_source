...
public final class l72 extends Fragment implements s32 {
    public static final WeakHashMap<ve, WeakReference<l72>> i = new WeakHashMap<>();
    ...
    public final void a(String str, LifecycleCallback lifecycleCallback) {
        if (!this.f.containsKey(str)) {
            ...
            if (this.g > 0) {
                new jl2(Looper.getMainLooper()).post(new k72(this, lifecycleCallback, str));
                return;
            }
            return;
        }
