...
public final class yu0 extends o86 implements h76<s56> {
    public final /* synthetic */ HomeScreenMainFragment f;

    /* JADX INFO: super call moved to the top of the method (can break code semantics) */
    public yu0(HomeScreenMainFragment homeScreenMainFragment) {
        super(0);
    ...
    public s56 invoke() {
        ...
        if (homeScreenMainFragment.getView() != null) {
            ...
            hd3.Y1(wg.b(viewLifecycleOwner), rl0.d(homeScreenMainFragment), null, new xu0(homeScreenMainFragment, null, homeScreenMainFragment), 2, null);
        }
        return s56.f3190a;
    }
}
