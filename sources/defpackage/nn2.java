                ...
                if (gj1.f1(b2)) {
                    ...
                    if (!(b2 < -32)) {
                        if (b2 < -16) {
                            if (i5 < i3 - 1) {
                                int i7 = i5 + 1;
                                gj1.W1(b2, bArr[i5], bArr[i7], cArr, i4);
                                i = i7 + 1;
                                i4++;
                            } else {
                                throw ma3.g();
                            ...
                            int i8 = i5 + 1;
                            int i9 = i8 + 1;
                            gj1.Z1(b2, bArr[i5], bArr[i8], bArr[i9], cArr, i4);
                            i4 += 2;
                            i = i9 + 1;
                        } else {
                            throw ma3.g();
