...
public final /* synthetic */ class ep0 implements Runnable {
    ...
    public /* synthetic */ ep0(HomeScreenMainFragment homeScreenMainFragment, List list) {
    ...
    public final void run() {
        ...
        if (homeScreenMainFragment.getView() != null) {
            ...
            hd3.Y1(wg.b(viewLifecycleOwner), rl0.d(homeScreenMainFragment), null, new ou0(homeScreenMainFragment, null, list, homeScreenMainFragment), 2, null);
        }
    }
}
