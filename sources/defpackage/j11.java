...
public final /* synthetic */ class j11 implements View.OnClickListener {
    public final /* synthetic */ hm0 f;
    public final /* synthetic */ SuperPass g;
    public final /* synthetic */ hm0 h;

    public /* synthetic */ j11(hm0 hm0, SuperPass superPass, hm0 hm02) {
        this.f = hm0;
        this.g = superPass;
        this.h = hm02;
    }
    ...
    public final void onClick(View view) {
        ...
        gi1.h(gi1.f1265a, "activation duration expired dialog view summary clicked", superPass, "Active Super Pass Visual validation Fragment", 0, 8);
        Context context = hm02.getContext();
        if (context != null) {
            SuperPassBookingSummaryActivity.s0(superPass.getSuperPassProperties().getPassId(), superPass.getSuperPassProperties().getProductSubType(), "Active Super Pass Visual validation Fragment", context);
        }
        ve activity = hm02.c();
        if (activity != null) {
            activity.finish();
