...
public class gf0 implements Comparator<Map.Entry<Long, String>>, j$.util.Comparator {
    public gf0(RenewMagicPassActivity renewMagicPassActivity) {
    }
    ...
    @Override // j$.util.Comparator, java.util.Comparator
    public /* synthetic */ Comparator<Map.Entry<Long, String>> reversed() {
    ...
    @Override // j$.util.Comparator, java.util.Comparator
    public /* synthetic */ java.util.Comparator<Map.Entry<Long, String>> thenComparing(java.util.Comparator<? super Map.Entry<Long, String>> comparator) {
