...
public final class w43 {
    ...
    public static final SparseArray<Pair<String, String>> f3727a;
    ...
    public static com.google.firebase.FirebaseException a(com.google.android.gms.common.api.Status r4) {
        ...
        */
        throw new UnsupportedOperationException("Method not decompiled: defpackage.w43.a(com.google.android.gms.common.api.Status):com.google.firebase.FirebaseException");
    }
    ...
    public static String b(String str, Status status) {
        ...
        return String.format(String.valueOf(str).concat(" [ %s ]"), status.h);
    }

    public static String c(int i) {
        Pair<String, String> pair = f3727a.get(i);
