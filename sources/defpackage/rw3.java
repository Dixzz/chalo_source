...
public class rw3<K extends Comparable<K>, V> extends AbstractMap<K, V> implements Map {
    public static final /* synthetic */ int l = 0;
    public final int f;
    public List<yw3> g = Collections.emptyList();
    public java.util.Map<K, V> h = Collections.emptyMap();
    public boolean i;
    public volatile ax3 j;
    public java.util.Map<K, V> k = Collections.emptyMap();

    public rw3(int i2, tw3 tw3) {
        this.f = i2;
    }
    ...
    public final V put(K k2, V v) {
        ...
        int i3 = this.f;
        if (size == i3) {
            yw3 remove = this.g.remove(i3 - 1);
            i().put(remove.f, remove.g);
        }
        this.g.add(i2, new yw3(this, k2, v));
        return null;
    }
    ...
    /* JADX DEBUG: Multi-variable search result rejected for r1v0, resolved type: rw3<K extends java.lang.Comparable<K>, V> */
    ...
    public boolean equals(Object obj) {
        ...
        int e = e();
        if (e != rw3.e()) {
            return entrySet().equals(rw3.entrySet());
        }
        for (int i2 = 0; i2 < e; i2++) {
            if (!d(i2).equals(rw3.d(i2))) {
                return false;
            }
        }
        if (e != size) {
            return this.h.equals(rw3.h);
        }
        return true;
    }
    ...
    public final V f(int i2) {
        ...
        if (!this.h.isEmpty()) {
            ...
            this.g.add(new yw3(this, it.next()));
            it.remove();
        }
        return v;
    }
    ...
    public final Iterable<Map.Entry<K, V>> g() {
        return this.h.isEmpty() ? (Iterable<Map.Entry<K, V>>) uw3.b : this.h.entrySet();
    }
