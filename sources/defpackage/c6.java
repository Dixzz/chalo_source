...
public class c6 {
    ...
    public static void b(c6[] c6VarArr, Path path) {
        int i;
        int i2;
        int i3;
        float[] fArr;
        ...
        char c4 = 'm';
        int i4 = 0;
        while (i4 < c6VarArr2.length) {
            char c5 = c6VarArr2[i4].f524a;
            float[] fArr3 = c6VarArr2[i4].b;
            float f20 = fArr2[c3];
            float f21 = fArr2[1];
            float f22 = fArr2[2];
            float f23 = fArr2[3];
    ...
    public c6(c6 c6Var) {
        this.f524a = c6Var.f524a;
        float[] fArr = c6Var.b;
        this.b = h.w(fArr, 0, fArr.length);
    }
}
