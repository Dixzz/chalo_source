...
/* compiled from: Utils */
public class wi1 implements Comparator<RouteInfo>, j$.util.Comparator {
    /* JADX DEBUG: Method arguments types fixed to match base method, original types: [java.lang.Object, java.lang.Object] */
    @Override // j$.util.Comparator, java.util.Comparator
    public int compare(RouteInfo routeInfo, RouteInfo routeInfo2) {
        return routeInfo.getRouteName().compareTo(routeInfo2.getRouteName());
    }

    /* Return type fixed from 'java.util.Comparator' to match base method */
    @Override // j$.util.Comparator, java.util.Comparator
    public /* synthetic */ Comparator<RouteInfo> reversed() {
    ...
    @Override // j$.util.Comparator, java.util.Comparator
    public /* synthetic */ java.util.Comparator<RouteInfo> thenComparing(java.util.Comparator<? super RouteInfo> comparator) {
