...
public class l2 extends Drawable {
    ...
    public l2(ColorStateList colorStateList, float f2) {
        this.f2154a = f2;
        this.b = new Paint(5);
        b(colorStateList);
        this.c = new RectF();
    ...
    public final void c(Rect rect) {
        ...
        this.d.set(rect);
        if (this.f) {
            float b2 = m2.b(this.e, this.f2154a, this.g);
            this.d.inset((int) Math.ceil((double) m2.a(this.e, this.f2154a, this.g)), (int) Math.ceil((double) b2));
            this.c.set(this.d);
        }
    }
    ...
    public void getOutline(Outline outline) {
        outline.setRoundRect(this.d, this.f2154a);
    }
