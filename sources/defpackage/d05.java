...
public abstract class d05 extends yz4 {
    public static final Logger b = Logger.getLogger(d05.class.getName());
    public static final boolean c = i25.h;
    ...
    /* renamed from: d05$b */
    /* compiled from: CodedOutputStream */
    public static abstract class b extends d05 {
        public final byte[] d;
        public final int e;
        public int f;
        public int g;
        ...
        public final void d0(int i) {
            if (d05.c) {
                ...
                while ((i & -128) != 0) {
                    ...
                    int i2 = this.f;
                    this.f = i2 + 1;
                    i25.s(bArr, (long) i2, (byte) ((i & 127) | 128));
                    i >>>= 7;
                }
                byte[] bArr2 = this.d;
                int i3 = this.f;
                this.f = i3 + 1;
                i25.s(bArr2, (long) i3, (byte) i);
        ...
        public final void e0(long j) {
            if (d05.c) {
                ...
                while ((j & -128) != 0) {
                    ...
                    int i = this.f;
                    this.f = i + 1;
                    i25.s(bArr, (long) i, (byte) ((((int) j) & 127) | 128));
                    j >>>= 7;
                }
                byte[] bArr2 = this.d;
                int i2 = this.f;
                this.f = i2 + 1;
                i25.s(bArr2, (long) i2, (byte) ((int) j));
    ...
    /* renamed from: d05$c */
    /* compiled from: CodedOutputStream */
    public static class c extends d05 {
        public final byte[] d;
        public final int e;
        public int f;
        ...
        @Override // defpackage.d05
        public final void I(int i, a05 a05) throws IOException {
            Y((i << 3) | 2);
            J(a05);
        }

        @Override // defpackage.d05
        public final void J(a05 a05) throws IOException {
            Y(a05.size());
            a05.C(this);
        }
        ...
        @Override // defpackage.d05
        public final void Q(int i, j15 j15, x15 x15) throws IOException {
            Y((i << 3) | 2);
            Y(((rz4) j15).getSerializedSize(x15));
            x15.h(j15, this.f774a);
        }

        @Override // defpackage.d05
        public final void R(j15 j15) throws IOException {
            Y(j15.getSerializedSize());
            j15.writeTo(this);
        }

        @Override // defpackage.d05
        public final void S(int i, j15 j15) throws IOException {
            W(1, 3);
            X(2, i);
            Y(26);
            Y(j15.getSerializedSize());
        ...
        @Override // defpackage.d05
        public final void T(int i, a05 a05) throws IOException {
            W(1, 3);
            X(2, i);
            I(3, a05);
            W(1, 4);
        ...
        public final void V(String str) throws IOException {
            int i = this.f;
            try {
                int z = d05.z(str.length() * 3);
                int z2 = d05.z(str.length());
                if (z2 == z) {
                    int i2 = i + z2;
                    this.f = i2;
                    int c = j25.c(str, this.d, i2, b0());
                    this.f = i;
                    Y((c - i) - z2);
                    this.f = c;
                    return;
                ...
                Y(j25.d(str));
                this.f = j25.c(str, this.d, this.f, b0());
            } catch (j25.c e2) {
                this.f = i;
                E(str, e2);
        ...
        public final void Y(int i) throws IOException {
            if (!d05.c || uz4.a() || b0() < 5) {
                ...
                int i4 = this.f;
                this.f = i4 + 1;
                i25.s(bArr3, (long) i4, (byte) i);
            } else {
                byte[] bArr4 = this.d;
                int i5 = this.f;
                this.f = i5 + 1;
                i25.s(bArr4, (long) i5, (byte) (i | 128));
                int i6 = i >>> 7;
                if ((i6 & -128) == 0) {
                    byte[] bArr5 = this.d;
                    int i7 = this.f;
                    this.f = i7 + 1;
                    i25.s(bArr5, (long) i7, (byte) i6);
                    return;
                }
                byte[] bArr6 = this.d;
                int i8 = this.f;
                this.f = i8 + 1;
                i25.s(bArr6, (long) i8, (byte) (i6 | 128));
                int i9 = i6 >>> 7;
                if ((i9 & -128) == 0) {
                    byte[] bArr7 = this.d;
                    int i10 = this.f;
                    this.f = i10 + 1;
                    i25.s(bArr7, (long) i10, (byte) i9);
                    return;
                }
                byte[] bArr8 = this.d;
                int i11 = this.f;
                this.f = i11 + 1;
                i25.s(bArr8, (long) i11, (byte) (i9 | 128));
                int i12 = i9 >>> 7;
                if ((i12 & -128) == 0) {
                    byte[] bArr9 = this.d;
                    int i13 = this.f;
                    this.f = i13 + 1;
                    i25.s(bArr9, (long) i13, (byte) i12);
                    return;
                }
                byte[] bArr10 = this.d;
                int i14 = this.f;
                this.f = i14 + 1;
                i25.s(bArr10, (long) i14, (byte) (i12 | 128));
                byte[] bArr11 = this.d;
                int i15 = this.f;
                this.f = i15 + 1;
                i25.s(bArr11, (long) i15, (byte) (i12 >>> 7));
            }
        }
        ...
        public final void a0(long j) throws IOException {
            if (!d05.c || b0() < 10) {
                ...
                while ((j & -128) != 0) {
                    ...
                    int i3 = this.f;
                    this.f = i3 + 1;
                    i25.s(bArr3, (long) i3, (byte) ((((int) j) & 127) | 128));
                    j >>>= 7;
                }
                byte[] bArr4 = this.d;
                int i4 = this.f;
                this.f = i4 + 1;
                i25.s(bArr4, (long) i4, (byte) ((int) j));
            }
        }
    ...
    public static final class e extends b {
        ...
        @Override // defpackage.d05
        public void I(int i, a05 a05) throws IOException {
            Y((i << 3) | 2);
            J(a05);
        }

        @Override // defpackage.d05
        public void J(a05 a05) throws IOException {
            Y(a05.size());
            a05.C(this);
        }
        ...
        @Override // defpackage.d05
        public void Q(int i, j15 j15, x15 x15) throws IOException {
            Y((i << 3) | 2);
            Y(((rz4) j15).getSerializedSize(x15));
            x15.h(j15, this.f774a);
        }
        ...
        @Override // defpackage.d05
        public void R(j15 j15) throws IOException {
            Y(j15.getSerializedSize());
            j15.writeTo(this);
        }

        @Override // defpackage.d05
        public void S(int i, j15 j15) throws IOException {
            W(1, 3);
            X(2, i);
            Y(26);
            Y(j15.getSerializedSize());
        ...
        @Override // defpackage.d05
        public void T(int i, a05 a05) throws IOException {
            W(1, 3);
            X(2, i);
            I(3, a05);
            W(1, 4);
        ...
        public void V(String str) throws IOException {
            ...
            try {
                ...
                if (z2 == z) {
                    ...
                    try {
                        this.f = i5;
                        int c2 = j25.c(str, this.d, i5, this.e - i5);
                        this.f = i4;
                        i = (c2 - i4) - z2;
                        d0(i);
                        this.f = c2;
                    ...
                    i = j25.d(str);
                    d0(i);
                    this.f = j25.c(str, this.d, this.f, i);
                }
                this.g += i;
            } catch (j25.c e3) {
                E(str, e3);
    ...
    public static int c(int i, a05 a05) {
        return x(i) + o(a05.size());
    }

    public static int d(a05 a05) {
        return o(a05.size());
    }
    ...
    @Deprecated
    public static int j(int i, j15 j15, x15 x15) {
        return (x(i) * 2) + ((rz4) j15).getSerializedSize(x15);
    }
    ...
    public static int n(w05 w05) {
        int i;
        if (w05.b != null) {
            i = w05.b.size();
        } else {
            i = w05.f3703a != null ? w05.f3703a.getSerializedSize() : 0;
        }
        return o(i);
    }
    ...
    public static int w(String str) {
        ...
        try {
            ...
            i = str.getBytes(s05.f3160a).length;
        }
        return o(i);
    }
    ...
    public abstract void I(int i, a05 a05) throws IOException;

    public abstract void J(a05 a05) throws IOException;
    ...
    public abstract void Q(int i, j15 j15, x15 x15) throws IOException;

    public abstract void R(j15 j15) throws IOException;

    public abstract void S(int i, j15 j15) throws IOException;

    public abstract void T(int i, a05 a05) throws IOException;
