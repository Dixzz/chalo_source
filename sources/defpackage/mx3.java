                ...
                if (hd3.R3(b2)) {
                    ...
                    if (!(b2 < -32)) {
                        if (b2 < -16) {
                            if (i6 < i3 - 1) {
                                int i8 = i6 + 1;
                                hd3.J3(b2, bArr[i6], bArr[i8], cArr, i5);
                                i = i8 + 1;
                                i5++;
                            } else {
                                throw cv3.e();
                            ...
                            byte b4 = bArr[i6];
                            int i10 = i9 + 1;
                            hd3.I3(b2, b4, bArr[i9], bArr[i10], cArr, i5);
                            i5 = i5 + 1 + 1;
                            i = i10 + 1;
                        } else {
                            throw cv3.e();
