...
public enum hc {
    ...
    SINT32_LIST_PACKED(47, r13, oc.INT),
    SINT64_LIST_PACKED(48, r13, r8),
    GROUP_LIST(49, r7, r14),
    MAP(50, a.MAP, oc.VOID);
    
    private static final Type[] EMPTY_TYPES = new Type[0];
    private static final hc[] VALUES = new hc[51];
    private final a collection;
    private final Class<?> elementType;
    private final int id;
    private final oc javaType;
    ...
    static {
        ...
        oc ocVar3 = oc.LONG;
        oc ocVar4 = oc.INT;
        oc ocVar5 = oc.BOOLEAN;
        oc ocVar6 = oc.STRING;
        oc ocVar7 = oc.MESSAGE;
        oc ocVar8 = oc.BYTE_STRING;
        oc ocVar9 = oc.ENUM;
        a aVar2 = a.VECTOR;
        ...
        hc[] values = values();
        for (hc hcVar : values) {
            VALUES[hcVar.id] = hcVar;
        }
    }

    private hc(int i, a aVar, oc ocVar) {
        int ordinal;
        this.id = i;
        ...
        boolean z = true;
        if (ordinal2 == 1) {
            this.elementType = ocVar.getBoxedType();
        } else if (ordinal2 != 3) {
            this.elementType = null;
        } else {
            this.elementType = ocVar.getBoxedType();
        }
        this.primitiveScalar = (aVar != a.SCALAR || (ordinal = ocVar.ordinal()) == 6 || ordinal == 7 || ordinal == 9) ? false : z;
    }

    public static hc forId(int i) {
        if (i < 0) {
            return null;
        }
        hc[] hcVarArr = VALUES;
