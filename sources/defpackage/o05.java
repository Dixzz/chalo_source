...
public final class o05 extends tz4<Float> implements s05.f, RandomAccess, r15 {
    public static final o05 i;
    public float[] g;
    public int h;

    static {
        o05 o05 = new o05(new float[0], 0);
        i = o05;
        o05.f = false;
    }
    ...
    public boolean addAll(Collection<? extends Float> collection) {
        ...
        if (Integer.MAX_VALUE - i3 >= i2) {
            ...
            System.arraycopy(o05.g, 0, this.g, this.h, o05.h);
            this.h = i4;
            ((AbstractList) this).modCount++;
            return true;
        }
    ...
    /* renamed from: n */
    public s05.f f(int i2) {
        if (i2 >= this.h) {
            return new o05(Arrays.copyOf(this.g, i2), this.h);
        }
