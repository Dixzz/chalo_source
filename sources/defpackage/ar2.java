...
public final class ar2 {
    ...
    public ar2(Context context, String str) throws IOException {
        Context applicationContext = context.getApplicationContext();
        if (str == null) {
            this.f323a = PreferenceManager.getDefaultSharedPreferences(applicationContext);
        } else {
            this.f323a = applicationContext.getSharedPreferences(str, 0);
        }
    }

    public final byte[] a() throws IOException {
        try {
            String string = this.f323a.getString("GenericIdpKeyset", null);
            if (string == null) {
