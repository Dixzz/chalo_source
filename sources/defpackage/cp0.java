...
public final /* synthetic */ class cp0 implements Runnable {
    ...
    public /* synthetic */ cp0(HomeScreenMainFragment homeScreenMainFragment, List list) {
    ...
    public final void run() {
        ...
        if (homeScreenMainFragment.getView() != null) {
            ...
            hd3.Y1(wg.b(viewLifecycleOwner), rl0.d(homeScreenMainFragment), null, new ju0(homeScreenMainFragment, null, homeScreenMainFragment, list), 2, null);
        }
    }
}
