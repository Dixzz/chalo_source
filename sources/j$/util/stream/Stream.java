...
public interface Stream<T> extends AbstractC0180l1<T, Stream<T>> {
    AbstractC0207s1 B(Function function);

    Stream P(Predicate predicate);

    Stream S(Consumer consumer);

    Object T(AbstractC0184m1 m1Var);
    ...
    AbstractC0207s1 h0(ToDoubleFunction toDoubleFunction);
